...
class SoftActorCritic():
    ...
    def reset(self):
        ...
        self.soft_q_net1 = SoftQNetwork(self.state_dim + 1, self.action_dim, self.hidden_dim).to(device)

        self.soft_q_net2 = SoftQNetwork(self.state_dim + 1, self.action_dim, self.hidden_dim).to(device)
        ...
        self.actor = Actor(self.state_dim + self.options_cnt, self.action_dim)
            ...
            while kdx < 2048:
                ...
                for step in range(self.max_steps):
                    ...
                    if frame_idx >=0:
                        ...
                        memory.append([extended_state.cpu().numpy(), action, reward, 1-done, extended_next_state.cpu().numpy(), extended_next_states.cpu().numpy()])
